...
export default function CurationAnimation() {
  const configRef = useRef({ ...defaultConfig, stageDurations: [...defaultConfig.stageDurations] });
  ...
  return (
    ...
    >
      <CurationCanvas configRef={configRef} onStageChange={setCurrentStage} restartRef={restartRef} />
